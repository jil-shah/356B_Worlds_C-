...
Motor Chasis_L1 (LEFTFRONT, MOTOR_GEARSET_18, false, MOTOR_ENCODER_DEGREES);
Motor Chasis_L2 (LEFTREAR, MOTOR_GEARSET_18, false, MOTOR_ENCODER_DEGREES);
Motor Chasis_R1 (RIGHTFRONT, MOTOR_GEARSET_18, true, MOTOR_ENCODER_DEGREES);
Motor Chasis_R2 (RIGHTREAR, MOTOR_GEARSET_18, true, MOTOR_ENCODER_DEGREES);
...
// set the max speed for slew control
 ...
 void driveOp(void* parameter){
   ...
   setBrakeMode(0);
     // Chassis Control
       Chasis_L1.set_brake_mode(pros::E_MOTOR_BRAKE_COAST);
       Chasis_L2.set_brake_mode(pros::E_MOTOR_BRAKE_COAST);
       Chasis_R1.set_brake_mode(pros::E_MOTOR_BRAKE_COAST);
       Chasis_R2.set_brake_mode(pros::E_MOTOR_BRAKE_COAST);
